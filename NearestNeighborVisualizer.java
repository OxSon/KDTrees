...
public class NearestNeighborVisualizer {
    ...
    public static void main(String[] args) {
        ...
        In in = new In(new Scanner(NearestNeighborVisualizer.class.getResourceAsStream(filename)));
        
        double MILLION = 1000000;
        long start = System.nanoTime();
		long end = System.nanoTime();
		double elapsedTime = (end - start) / MILLION;
		//System.out.printf("%-7d .. %-10.3f ms",  n, elapsedTime);
        ...
        while (true) {
            ...
            elapsedTime = (end - start) / MILLION;
            System.out.printf("%f ms", elapsedTime);
            StdDraw.show(0);
            StdDraw.show(40);
        }
    }
